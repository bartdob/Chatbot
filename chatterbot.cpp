...
record KnowledgeBase[] = {
	...
	{ {"BLACK"},
	{"PLEASE CHECK YOUR CONNECTIONS BETWEEN GRAPHICS CARD AND MONITOR, AND AC/DC CABLE TO MONITOR. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "IF YOU HAVE LAPTOP, MOVE YOUR SCREEN, IF YOU SEE SOMETHING ON IT, YOU HAVE BROKEN MATRIX TAPE. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "YOU SHOULD ALSO CONNECT EXTERNAL MONITOR BECAUSE IF MONITOR IS ALSO BLACK YOU HAVE PROBABLY BROKEN GRAPGICS CARD. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},
		//KEYBOARD

	{ {"KEYBOARD"},
	{"PLEASE CHECK YOUR CONNECTIONS BETWEEN UNIT AND KEYBOARD", 
	 "IF YOU HAVE LAPTOP YOU CAN RESTART UNIT, IF IT STILL DOESNT WORK, IT IS PROBABLY BROKEN :(",
		"IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},
		//dont start
	{ {"DOESNT START"},
	{"IF YOUR COMPUTER DOESNT START, IT COULD BE A LOT OF THINGS, FIRST OF ALL CHECK, IF UNIT IS PLUG IN TO THE POWER, IF IT DOESNT WORK, PROBABLY POWER ADAPTER IS DAMAGED, IT COULD GIVING NOT ENOUGHT VOLTAGE - YOU CAN CHECK THIS WITH MULITMETER. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "THE POWER SOCKET INSIDE COMPUTER CAN BE BROKEN. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
		"IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},
	...
	{ {"INTERNET", "WWW", "MAIL"},
	{"PLEASE CHCEK YOURS WIFI/ETHERNET ICON ON RIGHT DOWN CORNER AND CLICK SOLVE PROBLEMS. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "PLEASE CHCEK YOURS ROUTER AND MODEM, MAYBE THEY NEED RESTART. JUST UNPLUG WALL CABELS AND PLUG AFTER 5 MINUTES. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
		"IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},

	{ {"SOUND"},
	{"PLEASE CHCEK YOURS SOUND ICON ON RIGHT DOWN CORNER. SOUND COULD BE MUTE, SPEAKER COULD BE UNPLUGED WITH SOUNDCARD. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
		"IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},

	{ {"SLOW", "LAGS"},
	{"YOUR UNIT CAN BE SLOW BECAUSE YOU HAVE TO MANY ICONS ON DESKTOP. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	"MAYBE YOU HAVE NOT ENOGUHT SPACE IN DRIVE. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	"MAYBE YOUR PROCESSOR OR RAM IS OF OF DATE OR TOO LOW. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	"THERE IS A CHANCE THAT YOU HAVE A VIRUS. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	"IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},

	{ {"VIRUS"},
	{"IF UNIT SHOWS THAT YOU HAVE SOME SUSPECT BEHAVIOR, TO MAKE SURE OPEN A WINDOWS DEFENDER OR ANOTHER VIRUS PROGRAM TO SCAN COMPUTER",
	"IF THIS DO NOT HELP, PLEASE KONTAKT WITH SERVICE, SORRY"
	}
	},

	{ {"MOUSE", "TOUCHPAD"},
	{"IF MOUSE DOESNT WORK PLEASE CHECK BATTERY/CABLE TO UNIT. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "YOU CAN ALSO REMOVE YOUR MOUSE FROM DEVICES LIST ( WIN + R -> DEVMGMT.MSC) AND RESTART YOUR COMPUTER TO INSTAL NEW DRIVERS, IF THIS DO NOT HELP MOUSE IS DAMAGED OR U SWITCH BETWEEN OTHER DEVICES. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE."
	}
	},

	{ {"RESTART", "RESTARTS", "HANGS", "LAGS", "SLOW"},
	{"IF COMPUTER RESTARTS ON BEGINING, HANGS DURING WORK OR YOU CAN SEE BLUE SCREEN, YOU SHOULD TO TEST YOUR RAM - USE MEMTEST86 , IF PROGRAM SHOWS SOME ERRORS THE PROBLEM IS IN YOUR RAM. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE.",
	 "YOU CAN ALSO SCAN YOUR COMPUTER WITH ANTYWIRUS - IN SAFE MODE AND CHECK OUT TEMPERATURE OF YOUR CPU WITH FOR EXAMPLE HWiNFO, IF TEMPERATURE IS TO HIGH YOU SHOULD TO CLEAN YOUR RADIATOR. IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE."
	}
	},

	{ { "THX", "HELP", "THANK"},
	{"I AM GLAD I CAN HELP, SEE YOU NEXT TIME BYE BYE",
	 "IF IT DOESNT HELP YOU, REPEAT QUESTION PLEASE."
	}
	},
...
{
	//response_list.clear();									// czyszczenie listy
...
void CBot::select_response() 
{
	if(bot_understand()) 
	{
		//shuffle(response_list, response_list.size()); // nie losuje
...
{
	save_prev_response();
	// NIE ZACHOWUJE POPRZEDNIEJ ODPOWIEDZI
	...
	//else if(user_repeat())			bEZ POWTORZEN
	//{
...
void CBot::handle_repetition() // jest ok
{
	if(response_list.size() > 0)
	{
...
int main()
{
	std::cout << "Chatterbot v9.0" << std::endl;
